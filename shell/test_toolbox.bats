...
#
@test 'arc - extension' {
    run arc -c -s toolbox.sh -t test/toolbox.tar
...
@test 'arc - option' {
    run arc -s toolbox.sh -t test/toolbox.tar
...
@test 'arc - zip' {
    ...
    arc -c -s toolbox.sh -t test/toolbox.zip
    arc -x -s test/toolbox.zip -t test

    cmp --quiet toolbox.sh test/toolbox.sh
}

@test 'arc - zst' {
    mkdir --parent test

    arc -c -s toolbox.sh -t test/toolbox.tar.zst
    arc -x -s test/toolbox.tar.zst -t test
